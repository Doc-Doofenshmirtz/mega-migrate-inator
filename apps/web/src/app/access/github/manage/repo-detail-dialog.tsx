    ...
    <>
      ...
      >
        <div className="space-y-3">
          ...
          <div className="flex gap-1 border-b text-sm font-medium">
            {(
              [
                ...
                { key: "secrets", label: "Secrets & variables" },
              ] as const
            ).map((t) => (
              <button
                key={t.key}
                ...
                style={{
                  ...
                  color: tab === t.key ? "var(--color-fg)" : "var(--color-muted)",
                }}
              >
                {t.label}
              </button>
          ...
          {tab === "secrets" && <SecretsPane owner={owner} repo={repo.name} />}
